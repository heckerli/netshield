...
protected:
	...
	AttrType type_;	//type of attr, represents child class
	Expr *expr_;		//initialized to 0 for LetAttr
	SeqEnd *seqend_;	//initialized to 0 for LetAttr
};
...
private:
	FieldList *letfields_;	//the list of letfield in the &let statement 
};
