...
public:
	...
	Expr *index_expr_; // passed in constructor, first arg
	ID *index_var_; // initialized to 0
	CaseFieldList *cases_; // passed in constructor, second arg, all cases
...
//protected:
public:
	CaseType *case_type_; // initialized to 0
	ExprList *index_; // constructor, 1st arg, passed to Field, index
	const ID *index_var_; // initialized elsewhere
};
