...
//private:
public:
	ID *type_id_;		//the ID passed in to create this type, or type name
	ExprList *args_;		//for "bool", initialized to 0
	char *data_type_;
	bool checking_requires_analyzer_context_;	//initialized to 0
